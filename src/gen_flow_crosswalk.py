#!/usr/bin/env python3
"""
gen_flow_crosswalk.py  — <횡단보도 시나리오> 테스트 음성을 하나의 mp3로 만든다.
멘트는 코드(step_converter.py)에 정해진 문구 그대로 사용.

실행:  python src/gen_flow_crosswalk.py   →  flow_crosswalk.mp3
필요:  pip install gTTS pydub  +  ffmpeg  (인터넷 필요)
"""
import os, sys, tempfile

OUT_FILE = "flow_crosswalk.mp3"
BITRATE = "192k"
...
FLOW = [
    (0.0,        "안내를 시작합니다."),
    (DEFAULT_GAP, "정지. 사람."),
    (BUTTON_GAP, "열한 시 방향에 횡단보도."),   # ← 버튼 누른 후
]
